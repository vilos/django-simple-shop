...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CategoryImage.icon'
        db.add_column('catalog_categoryimage', 'icon', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'ProductAttribute.group'
        db.alter_column('catalog_productattribute', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.AttributeGroup'], null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'CategoryImage.icon'
        db.delete_column('catalog_categoryimage', 'icon')

        # Changing field 'ProductAttribute.group'
        db.alter_column('catalog_productattribute', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.AttributeGroup']))
    ...
    models = {
        ...
        'catalog.categoryimage': {
            ...
            'icon': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'catalog.productattribute': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.AttributeGroup']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'sort': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
