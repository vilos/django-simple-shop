...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catalog_categoryimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', blank=True, null=True, to=orm['catalog.Category'])),
        ...
        db.send_create_signal('catalog', ['CategoryImage'])

        # Changing field 'ProductImage.caption'
        db.alter_column('catalog_productimage', 'caption', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))

        # Adding unique constraint on 'ProductImage', fields ['sort', 'product']
        db.create_unique('catalog_productimage', ['sort', 'product_id'])


    def backwards(self, orm):
        
        # Deleting model 'CategoryImage'
        db.delete_table('catalog_categoryimage')

        # Changing field 'ProductImage.caption'
        db.alter_column('catalog_productimage', 'caption', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))

        # Removing unique constraint on 'ProductImage', fields ['sort', 'product']
        db.delete_unique('catalog_productimage', ['sort', 'product_id'])
    ...
    models = {
        ...
        'catalog.categoryimage': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'blank': 'True', 'null': 'True', 'to': "orm['catalog.Category']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'catalog.productimage': {
            'Meta': {'unique_together': "(('product', 'sort'),)", 'object_name': 'ProductImage'},
            'caption': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['filer.Image']", 'null': 'True', 'blank': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'blank': 'True', 'null': 'True', 'to': "orm['catalog.Product']"}),
            'sort': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
